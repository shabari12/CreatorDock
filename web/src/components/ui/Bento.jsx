...
const items = [
  {
    ...
    description: (
      <span className="text-sm">
        Simplify your video editing process with Creator Dock's intuitive tools.
      </span>
    ),
    header: <SkeletonOne />,
  ...
  },
  {
    ...
    description: (
      <span className="text-sm">
        Collaborate with your team in real-time on video projects.
      </span>
    ),
    header: <SkeletonTwo />,
    className: "md:col-span-1",
  ...
  },
  {
    ...
    description: (
      <span className="text-sm">
        Publish your videos directly to YouTube with just a few clicks.
      </span>
    ),
    header: <SkeletonFour />,
  ...
  },
  {
    ...
    description: (
      <span className="text-sm">
        Keep your drafts, edits, and final videos organized in one place.
      </span>
    ),
    header: <SkeletonFive />,
    className: "md:col-span-1",
